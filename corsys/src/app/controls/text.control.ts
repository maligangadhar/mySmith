...
@Component({
		selector: 'sp3-comp-text',
		templateUrl: './text.control.html'
})

export class SpTextComponent implements OnInit{
		...
		constructor( @Inject('ICommonService') private commonService: ICommonService) {
				...
				vm.onFocusOut = () => {
						...
						if (vm.newValue.trim() === '' && vm.required === true) {
				...
				vm.setMessage = () => {
						...
						else if (vm.isShipIdInValid || vm.isHsCodeValid || vm.isOverallWeight) {
				...
				/**
         * This code block is depreciated and will be removed as part of Task:- 2992
         */
